...
#define CAN_FT_DLC		 6							// Fault Condition data length //NEW
...
#define MC_Refresh_Interval	50						// Motor controller refresh interval

#define MC_MAX_ERRNUM	 5							// Max number of failed MC responses
#define MC_RES_TIMEOUT	 50							// Motor controller connection respond timeout (ticks)
...
#define dcb_nodeID			7						// Driver ctrl board nodeID
...
#define dcb_P2P			dcb_nodeID + p2pOffset
// P2P IDs END
...
#define dcb_SW			dcd_nodeID + swOffset
// Status Word IDs END
...
#define dcb_FW			dcb_nodeID + fwOffset
